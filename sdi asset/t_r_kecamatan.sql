...
--
-- Host: localhost
-- Waktu pembuatan: 24 Okt 2023 pada 05.01
...
--
-- Struktur dari tabel `t_r_kecamatan`
--
...
--
-- Dumping data untuk tabel `t_r_kecamatan`
--

INSERT INTO `t_r_kecamatan` (`kecamatan_id`, `kabupaten_id`, `nama`) VALUES
...
--
-- Indeks untuk tabel `t_r_kecamatan`
--
ALTER TABLE `t_r_kecamatan`
...
--
-- AUTO_INCREMENT untuk tabel `t_r_kecamatan`
--
ALTER TABLE `t_r_kecamatan`
  MODIFY `kecamatan_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9471041;
COMMIT;
