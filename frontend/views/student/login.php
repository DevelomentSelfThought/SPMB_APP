        ...
        <div class="col-lg-5">
            <div class="card my-5">
                ...
                <div class="form-group" style="display: flex; justify-content: flex-end;">
                    <?=  Html::resetButton('Lupa Password', ['class' => 'btn btn-primary','style' => 'background-color: #007bff; color: #fff; margin-right: 10px; width: 150px;']) ?>
                    <?=  Html::submitButton('Masuk', ['class' => 'btn btn-primary','style' => 'background-color: #007bff; color: #fff; width: 150px;']) ?>
                </div>
                    <?php ActiveForm::end(); ?>
